...
project = "qtpy-dynamic-font-size-label"
...
htmlhelp_basename = "qtpy-dynamic-font-size-label_namedoc"
...
latex_documents = [
    (
        master_doc,
        "qtpy-dynamic-font-size-label.tex",
        "qtpy-dynamic-font-size-label Documentation",
